...
> Generated by `.github/workflows/snake.yml`, running every 6 hours (and on demand from the Actions tab). It publishes to the `output` branch — no manual regeneration needed.
