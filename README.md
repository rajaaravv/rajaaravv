...
- Beginner-friendly, data-focused open-source contributions
...
<img src="https://raw.githubusercontent.com/rajaaravv/rajaaravv/output/dist/github-snake-dark.svg" alt="snake animation" width="100%"/>

</div>

> Generated by the `.github/workflows/snake.yml` action in this repo — it runs every 24h, builds `dist/github-snake-dark.svg` (and a light + ocean-gif variant), and pushes them to the `output` branch. No manual regeneration needed once it's merged.
